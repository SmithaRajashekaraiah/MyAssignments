...
function isAnagram(str1,str2){
    ...
    for(let i=0;i<=sortString1.length-1;i++){
        ...
        {
            return false // return false if the character doesnot match
        }
    }return true // returns true if all the charcters in a string matches in both string
        
}
console.log(isAnagram('Listen','Silent')) // this is an anagram
console.log(isAnagram('Hello','World')) // this is not an anagram
